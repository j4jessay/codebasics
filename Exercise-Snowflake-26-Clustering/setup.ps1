# Exercise 26: Snowflake Clustering Setup (Windows PowerShell)

Write-Host "==========================================" -ForegroundColor Cyan
Write-Host "🚀 Snowflake Clustering Exercise Setup" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "📊 Generating 50,000 sales records in Snowflake..." -ForegroundColor Yellow
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  - Try from a different network if S3 is blocked"
    Write-Host ""
}
Write-Host ""
